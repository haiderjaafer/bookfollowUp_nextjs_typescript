...
import { BookStatusCounts, BookTypeCounts, UserBookCount } from '@/app/page';


interface MemoBookLandingProps {
...
const MemoBookLanding: React.FC<MemoBookLandingProps> = ({
  bookTypeCounts,
  bookStatusCounts,
  userBookCounts,
  ...
  return (
  <div className="relative overflow-hidden w-full h-[300px] rounded-lg">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
        ...
        >
          <div className="w-12 h-16 bg-purple-500 rounded opacity-30 shadow-lg transform -rotate-6"></div>
        </div>
        <div
          className="absolute bottom-20 left-20 animate-bounce"
          style={{ animationDelay: '2s', animationDuration: '3.5s' }}
        >
          <div className="w-14 h-18 bg-cyan-500 rounded opacity-30 shadow-lg transform rotate-6"></div>
        </div>
        <div
          className="absolute bottom-32 right-16 animate-bounce"
          style={{ animationDelay: '0.5s', animationDuration: '4.5s' }}
        >
          <div className="w-10 h-14 bg-indigo-500 rounded opacity-30 shadow-lg transform -rotate-12"></div>
        </div>
      </div>
...
export default MemoBookLanding;