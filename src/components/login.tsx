    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-4">
      ...
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl grid lg:grid-cols-2 overflow-hidden">
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center">
          ...
          {/* Title */}
          <h2 className="text-3xl font-bold text-gray-800 mb-4 text-center">Login to Your Account</h2>
          {/* Subtitle/Greeting */}
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <a href="#" className="font-medium text-indigo-600 hover:text-indigo-500 transition duration-200">Forgot your password?</a>
            </div>
          ...
          <div className="space-y-4">
            ...
            {/* Add other social logins similarly (Facebook, Twitter, etc.) */}
          </div>
        ...
        <div className="hidden lg:block relative">
          ...
          <div className="absolute bottom-10 left-10 text-white p-4">
            <h3 className="text-3xl font-semibold mb-2">Unlock Your Potential</h3>
            <p className="text-lg">Join our community and start your journey.</p>
          </div>
        </div>
